...
Tips：歡迎訪問 [加入社群](/cn/other/community)，討論問題以及溝通需求。
...
如果您有一定的技術基礎，可以嘗試使用 **AI 輔助轉換** 的方式，將您的數據轉換為標準格式。詳情請查看 [AI 輔助轉換指南](/cn/standard/ai-converter)。

此外，如果您是開發者，並已支援了其他聊天應用的聊天記錄匯出，歡迎[相容 ChatLab 格式](/cn/standard/chatlab-format)，我會將您的 Github 連結加到這裡。
